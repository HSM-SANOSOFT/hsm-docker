...
exec infisical run --token $INFISICAL_TOKEN --projectId $PROJECT_ID --domain $INFISICAL_API_URL --path $SECRET_PATH --env dev -- minio server /data --console-address ":9001"